...
@FXML private Label votos4;
    ...
    */
    public void DatosCandidato1() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM registrovotos INNER JOIN candidato_p_republica ON registrovotos.idCandidato = candidato_p_republica.idCandidato WHERE registrovotos.idCandidato=1 AND registrovotos.idTipoVoto=1";
 ...
 imagen3.setImage(image1);
    ...
    */
    public void EstadisticasCandidato1() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT COUNT(DISTINCT idRegistroVoto) FROM registrovotos WHERE registrovotos.idCandidato=1 AND registrovotos.idTipoVoto=1";
     //String Consulta="SELECT votos, Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM view.fvotosuno";
              ConsultaCandidatosGobierno cons = new ConsultaCandidatosGobierno(Consulta);
        cons.getError();
...
votos3.setText("Numero de votos: "+ votos);
    ...
    */ 
    public void DatosCandidato2() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM registrovotos INNER JOIN candidato_p_republica ON registrovotos.idCandidato = candidato_p_republica.idCandidato WHERE registrovotos.idCandidato=2 AND registrovotos.idTipoVoto=1";
     //String Consulta="SELECT votos, Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM view.fvotosuno";
              ConsultaCandidatosGobierno cons = new ConsultaCandidatosGobierno(Consulta);
        cons.getError();
...
//votos1.setText("Numero de votos: "+ votos);
 ...
 imagen2.setImage(image1);
    ...
    public void EstadisticasCandidato2() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT COUNT(DISTINCT idRegistroVoto) FROM registrovotos WHERE registrovotos.idCandidato=2 AND registrovotos.idTipoVoto=1";
     //String Consulta="SELECT votos, Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM view.fvotosuno";
              ConsultaCandidatosGobierno cons = new ConsultaCandidatosGobierno(Consulta);
        cons.getError();
...
votos2.setText("Numero de votos: "+ votos);
    ...
    public void DatosCandidato3() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM registrovotos INNER JOIN candidato_p_republica ON registrovotos.idCandidato = candidato_p_republica.idCandidato WHERE registrovotos.idCandidato=3 AND registrovotos.idTipoVoto=1";
     //String Consulta="SELECT votos, Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM view.fvotosuno";
              ConsultaCandidatosGobierno cons = new ConsultaCandidatosGobierno(Consulta);
        cons.getError();
...
//votos1.setText("Numero de votos: "+ votos);
 ...
 imagen4.setImage(image1);
    ...
    public void EstadisticasCandidato3() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT COUNT(DISTINCT idRegistroVoto) FROM registrovotos WHERE registrovotos.idCandidato=3 AND registrovotos.idTipoVoto=1";
     //String Consulta="SELECT votos, Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM view.fvotosuno";
              ConsultaCandidatosGobierno cons = new ConsultaCandidatosGobierno(Consulta);
        cons.getError();
...
votos4.setText("Numero de votos: "+ votos);
    ...
    public void DatosCandidato4() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM registrovotos INNER JOIN candidato_p_republica ON registrovotos.idCandidato = candidato_p_republica.idCandidato WHERE registrovotos.idCandidato=4 AND registrovotos.idTipoVoto=1";
     //String Consulta="SELECT votos, Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM view.fvotosuno";
              ConsultaCandidatosGobierno cons = new ConsultaCandidatosGobierno(Consulta);
        cons.getError();
 ...
 imagen1.setImage(image1);
    ...
    */
    public void EstadisticasCandidato4() throws SQLException, IOException, Exception{
        ...
        ResultSet rs;
    String Consulta="SELECT COUNT(DISTINCT idRegistroVoto) FROM registrovotos WHERE registrovotos.idCandidato=4 AND registrovotos.idTipoVoto=1";
     //String Consulta="SELECT votos, Nombres,ApellidoPaterno,ApellidoMaterno,Perfil FROM view.fvotosuno";
              ConsultaCandidatosGobierno cons = new ConsultaCandidatosGobierno(Consulta);
        cons.getError();
